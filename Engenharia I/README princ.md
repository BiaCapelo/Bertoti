...
Engenharia de software, mesmo abrengendo a programação, é mais especifica no quesito de controle de tempo e tomada de decisão para compensação de escala e pois seu crescimento é diretamente proporcional a esses requisitos, impactando sua eficiencia quando não atendido algum deles.
